...
<?php $datauser = get_cookie('datauser') ? json_decode(get_cookie('datauser')) : redirect()->to(base_url()); ?>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="/assets/images/users/avatar/<?= $datauser->avatar ?>" alt="users" class="rounded-circle" width="40" /></div>
                                <div class="user-content hide-menu m-l-10">
                                    <a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h5 class="m-b-0 user-name font-medium"><?= $datauser->nama; ?><i class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email"><?= $datauser->email; ?></span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="Userdd">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" id="authLogout" href=""><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End User Profile-->
