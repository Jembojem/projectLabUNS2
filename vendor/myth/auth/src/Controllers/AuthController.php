...
class AuthController extends Controller
{
	...
	public function attemptRegister()
	{
		...
		// Save the user
		$allowedPostFields = array_merge(['name'], ['avatar'], ['password'], $this->config->validFields, $this->config->personalFields);
		...
		// $user->editAttributes('avatar', $namaAva);
		// dd($users->queries);
		// dd($users->getAllAttributes());
